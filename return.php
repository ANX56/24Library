                    ...
                    <div class="col">
                        <form action="return.php" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="returnid" disabled>
                            </div>
                            <div class="form-group">
                                <label for="borrowid">Borrow ID</label>
                                <input type="text" class="form-control" name="borrowid" disabled>
                            </div>
                            <div class="form-group">
                                <label for="totaldeposit">Total Borrowed Books</label>
                                <input type="number" class="form-control" name="totaldeposit" disabled>
                            </div>
                            <div class="form-group">
                                <label for="borrowdate">Borrow Date</label>
                                <input type="date" class="form-control" name="borrowdate" disabled>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="latedays" disabled>
                            </div>
                            <div class="form-group">
                                <label for="latefees">Late Fees</label>
                                <input type="text" class="form-control" name="latefees" disabled>
                            </div><hr>
                            <div class="form-group">
                                <label for="depositchange">Deposit Change</label>
                                <input type="text" class="form-control" name="depositchange" disabled>
                            </div>
                            <div class="form-group">
                                <label for="additionalpayment">Additional Payment</label>
                                <input type="text" class="form-control" name="additionalpayment">
                            </div>
                            <div class="col">
                                <div class="row mb-2">
                                    <button class="form-control btn btn-outline-info" type="return">Return</button>
                                </div>
                            </div>
                        </form>
                    </div>
